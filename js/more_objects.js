...
// getAverageSalesPerEmployee() should return the average units sold per employee
    ...
    console.log("Employee count: " + getEmployeeCount())

    function getTotalNumberOfSales(){
        let total = 0;
        salesReport.employees.forEach(function (el) {
            total += el.salesUnits
        })
        return total;
        }

    console.log("Sales units: " + getTotalNumberOfSales());
