...
let tipPercentage = parseFloat(prompt("How much percentage(as a decimal) would you like to leave as a tip?"));
let amountToTip = (tipPercentage  * billTotal);
alert("Your dollar amount you should tip is " + amountToTip.toFixed(2));
